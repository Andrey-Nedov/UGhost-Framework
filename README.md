...
Работа выполнялась для выступления на научно-практической конференции в МГТУ им. Баумана на программу "Шаг в будущее" и получила 63 балла из 70. На базе фреймворка UGhost было написано десктоп- и мобильная версия демо-приложения, которое реализовывало эхо-диалог в котором бот повторял полученную от пользователя фразу.
